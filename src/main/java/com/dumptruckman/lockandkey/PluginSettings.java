...
public final class PluginSettings extends Settings {
    ...
    public final static class LockSettings {
        ...
        public final static class Descriptions {
            ...
            private String uncutKeyUsesLore = "Uses: $uses";

            @Comment({"This shows how many more times the key can be used to open a lock"})
            private String keyUsesLore = "Uses: $uses";
            ...
            public String getKeyUsesLore(Integer uses) {
                return keyUsesLore.replace("$uses", uses.toString());
            }
        }
    }
}
